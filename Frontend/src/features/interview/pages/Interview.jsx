...
import Loading from "../../auth/component/loading";
...
// ── Sub-components ────────────────────────────────────────────────────────────
const QuestionCard = ({ item, index, open, onToggle }) => {
  ...
  return (
    <div ref={cardRef} className="q-card">
      <div className="q-card__header" onClick={() => onToggle(index)}>
